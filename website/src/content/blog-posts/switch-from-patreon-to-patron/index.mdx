...
**Making a platform switch can feel daunting.** You've built a community on Patreon, and the last thing you want is to lose those hard-won supporters. But with [Patreon's recent fee hikes to 10% for new creators](https://www.patron.com/blog/post/patreon-fee-changes-2025/) and the emergence of new creator-friendly platforms like [Patron](https://www.patron.com/), many creators are considering a move.
...
At around $20k per month, traditional platform fees of 10% would be about $2,000. [Patron's 1% fee](https://www.patron.com/blog/post/patreon-fee-changes-2025/) would be just $200, meaning ArcaneCadence would keep an extra **$1,800 every month**. At their current trajectory (over [$30k/month as of late 2025](https://graphtreon.com/creator/ArcaneCadence)), they'd save even more.
...
Compare a couple months of [Patron](https://www.patron.com/) income to your old platform baseline. Account for the fact [Patron fees are lower](https://www.patron.com/blog/post/patreon-fee-changes-2025/). Your net might be the same or higher even if raw supporter count is a bit down.
...
All data and examples here reflect the landscape as of 2025, a time of rapid shifts in the creator economy. [Patreon's fee changes in 2025](https://www.patron.com/blog/post/patreon-fee-changes-2025/) shook things up, but also opened the door for alternatives like [Patron](https://www.patron.com/) to innovate.
