...
If you're using [Patron's 1% platform fee](https://www.patron.com/blog/post/patreon-fee-changes-2025/) instead of traditional 10% fees, both models become far more favorable, though annual still saves on transaction fees.
...
**Platform fee awareness.** Traditional platforms take 10% on every payment. Annual means fewer transactions but the percentage is the same. [Patron's 1% fee structure](https://www.patron.com/blog/post/patreon-fee-changes-2025/) makes a significant difference in what you actually keep.
