...
summary: >-
  Major updates: new changelog page with RSS, complete blog system, user authentication, and improvements to SEO and accessibility.
author: Nick Khami
...
**_TL;DR: We launched a dedicated changelog page with RSS feed, built out the complete blog system with CMS, added user authentication across client and server, and made major improvements to the website's SEO, accessibility, and mobile experience._**
