 ...
 */
export function outrankProcessWebhook(
  client: PatrontsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.OutrankWebhookPayload$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/outrank/webhook")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.OutrankWebhookResponse$inboundSchema),
