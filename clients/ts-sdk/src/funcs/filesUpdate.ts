...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateFileRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateUserFileRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserFileInfo$inboundSchema),
