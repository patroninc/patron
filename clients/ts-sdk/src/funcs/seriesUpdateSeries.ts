 ...
 */
export function seriesUpdateSeries(
  client: PatrontsCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateSeriesRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateSeriesRequest, {
    explode: true,
  });
  ...
  >(
    ...
    M.jsonErr([401, 403, 404, 409], errors.ErrorResponse$inboundSchema),
