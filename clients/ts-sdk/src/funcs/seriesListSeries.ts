...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSeriesRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/series")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.SeriesResponse$inboundSchema)),
