...
> {
  const parsed = safeParse(
    request,
    (value) => models.UpdateUserInfoRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/auth/me")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateUserInfoResponse$inboundSchema),
