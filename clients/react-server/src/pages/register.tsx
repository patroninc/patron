...
function UserDetailsStep({
  ...
  onNext: (data: { displayName: string; password: string; repeatPassword: string }) => void;
  onBack: () => void;
  initialData?: {
    displayName: string;
    password: string;
              ...
              <FormControl className="w-full">
                <div className="flex items-center">
                  <div className="relative z-[2] flex h-full items-center">
                    ...
                    <div className="bg-accent h-[calc(100%-6px)] w-[3px] border-y-3 border-y-black"></div>
                    <div className="bg-accent flex h-full items-center border-y-3 border-y-black pr-[12px] pl-[9px] text-sm">
                      Patron.com/
                    </div>
                  </div>
                  <Input
    ...
    <Form {...form}>
      ...
      >
        <FormField
          ...
          name="isNsfw"
          render={({ field }) => (
            <FormItem className="flex flex-row items-center justify-center space-y-0 space-x-3">
              <FormControl>
...
export default function Register() {
  ...
  const handlePageDetailsSubmit = (pageData: { pageName: string; pageUrl: string }) => {
